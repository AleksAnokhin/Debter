...
abstract class Model_work_liquidation {
    ...
    public static function simpleInsert($id,$data,$table)
    {
        $insert = (new Insert())->setTable($table)->setColumns($data)->setValues($data)->setRow();
        if($insert) {
            return true;
    ...
    public static function insertBroaden($id,$total,$real,$terms,$data,$table)
    {
        $insert = (new Insert())->setTable($table)->setColumns($data)->setValues($data)->setRow();
        if($insert) {
            return true;
