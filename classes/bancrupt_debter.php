...
class Bancrupt_debter extends Model_debter implements Debter {
	...
	public function getInfo() {
		$tables = ['collection_stage','main_parameters','bancrupts_stage','type_of_debter'];
		$cond = ['collection_stage'=>'debters.id = collection_stage.debters_id','main_parameters'=>'collection_stage.debters_id=main_parameters.debters_id',
				 'bancrupts_stage'=>'main_parameters.debters_id=bancrupts_stage.debters_id',
				'type_of_debter'=>'bancrupts_stage.debters_id=type_of_debter.debters_id'];
		$id = $this->id;
		$maintable = 'debters';
